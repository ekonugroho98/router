/**
 * Addon: Pollinations Cloud Bulk Auto-Add
 *
 * Proxy endpoint dari 9router UI ke unified sidecar service (default port 9100).
 * Same sidecar as kiro-bulk/openrouter-bulk, beda di provider param: "pollinations".
 */
...
// ─── GET /api/addon/pollinations-bulk → cek sidecar health ───────────────────
...
// ─── POST /api/addon/pollinations-bulk → forward ke sidecar dengan provider=pollinations ───
