/**
 * Addon: SiliconFlow Cloud Bulk Auto-Add
 *
 * Proxy endpoint dari 9router UI ke unified sidecar service (default port 9100).
 * Same sidecar as kiro-bulk/openrouter-bulk, beda di provider param: "siliconflow".
 */
...
// ─── GET /api/addon/siliconflow-bulk → cek sidecar health ───────────────────
...
// ─── POST /api/addon/siliconflow-bulk → forward ke sidecar dengan provider=siliconflow ───
